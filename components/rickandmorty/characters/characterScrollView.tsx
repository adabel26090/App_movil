...
export function CharacterScrollView() {  
    ...
    const [data, setData] = useState<CharacterResult>({  // Datos de los personajes y la información adicional
        info: {
            pages:0,
    ...
    return (  
        <SafeAreaView style={styles.content}>  {/* Contenedor principal */}
            ...
            <FlatList  
                ...
                renderItem={({ item }) => (  
                    <CharacterCard character={item}></CharacterCard>  // Renderiza una tarjeta para cada personaje
                )}  
